  ...
  <!-- Description / Tab cards -->
        <div class="container mt-6">
          <div class="text-center mb-4">
            <h2>Ready to <span class="text-normal">explore</span> and decide for yourself?</h2>
            <router-link to="/tags" class="btn btn-block btn-raised btn-warning">Check out our charts & Maps!</router-link>
          </div>
<!--           <div class="row">
            <div class="col-lg-6">
